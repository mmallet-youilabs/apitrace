...
QT_MOC_LITERAL(1, 12, 10), // "slotUpdate"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 9), // "showPixel"
QT_MOC_LITERAL(4, 34, 8), // "showGrid"
QT_MOC_LITERAL(5, 43, 4) // "rect"

    },
    "ImageViewer\0slotUpdate\0\0showPixel\0"
    "showGrid\0rect"
};
...
void ImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showPixel((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->showGrid((*reinterpret_cast< const QRect(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject ImageViewer::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ImageViewer.data,
...
void *ImageViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_ImageViewer"))
        return static_cast< Ui_ImageViewer*>(this);
